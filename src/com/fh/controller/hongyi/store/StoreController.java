package com.fh.controller.hongyi.store;
...
import com.fh.service.hongyi.store.StoreManager;
...
public class StoreController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("hongyi/store/store_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("hongyi/store/store_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("MANAGER_ID"));	    //2
			vpd.put("var3", varOList.get(i).getString("MANAGER_NAME"));	    //3
			vpd.put("var4", varOList.get(i).getString("ADDRESS"));	    //4
			vpd.put("var5", varOList.get(i).getString("PICTURE"));	    //5
			vpd.put("var6", varOList.get(i).getString("PHONE_NUMBER"));	    //6
			varList.add(vpd);
		}
